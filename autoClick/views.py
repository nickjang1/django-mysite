...
def coordinate(request):
    subprocess.run([sys.executable, '/Volumes/WORK/work/django/mysite/autoClick/coordinate.py'],
...
def inputClicks(request):
    ...
    npPath = "/Volumes/WORK/work/django/mysite/autoClick"
...
def click(request):
    out = subprocess.run([sys.executable, '/Volumes/WORK/work/django/mysite/autoClick/click.py'],
                         shell=False, stdout=subprocess.PIPE)
